...
exports.GetPokemonByUrlGateway = void 0;
...
class GetPokemonByUrlGateway {
    execute(url) {
        return __awaiter(this, void 0, void 0, function* () {
            const responseApi = yield FetchClientUtil_1.default.get(url);
            const pokemonApi = responseApi;
            return (0, pokemonApiToPokemonMapper_1.default)(pokemonApi);
        });
    }
}
exports.GetPokemonByUrlGateway = GetPokemonByUrlGateway;
//# sourceMappingURL=getPokemonByUrlGateway.js.map